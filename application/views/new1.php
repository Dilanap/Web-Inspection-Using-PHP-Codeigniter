...
<?php if ($this->session->userdata('jabatan')=='Operator' )
 ...
 <li>
					...
					<li>
                    <a href="<?php echo site_url('cpar');?>" style="color: #fffcfc;"> <i class="fa fa-fw fa-edit"></i> CPAR</a>
                    </li>
    ...
    <?php if ($this->session->userdata('jabatan')=='Pelanggan') 
            ...
            ?> 
                    ...
                    <li>
                    <a href="<?php echo site_url('Po');?>" style="color: #fffcfc;"> <i class="fa fa-fw fa-edit"></i> Data PO</a>
                    </li>
					
					<li>
                    <a href="<?php echo site_url('Po/Lihat_data');?>" style="color: #fffcfc;"> <i class="fa fa-fw fa-edit"></i> Lihat Data PO</a>
                    </li>
