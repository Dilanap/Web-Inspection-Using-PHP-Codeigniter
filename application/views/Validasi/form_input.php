...
<table class="table table-bordered">
     ...
     <tr>
         <td>Dikeluarkan sehubungan dengan : </td>
          <td>
               <input type="checkbox" name="Id_reason" value = "RSN-001" /> External Complain <BR>
               <input type="checkbox" name="Id_reason" value = "RSN-002" /> Internal Audit <BR>
               <input type="checkbox" name="Id_reason" value = "RSN-003" /> Peformance Produk <BR>
               <input type="checkbox" name="Id_reason" value = "RSN-004" /> Peformance Mesin <BR>
               <input type="checkbox" name="Id_reason" value = "RSN-005" /> Peformance Lingkungan Safety <BR>
          </td>
     </tr>
