    ...
    public function index()
    {
      // Konfigurasi email
        $config = [
               ...
               'smtp_user' => 'rinjani.intan19@gmail.com',    // Ganti dengan email gmail kamu
               'smtp_pass' => '@sayangku',      // Password gmail kamu
               'smtp_port' => 465,
               'crlf'      => "\r\n",
               'newline'   => "\r\n"
           ];
        ...
        // Email penerima
        $this->email->to('irinjani63@gmail.com'); // Ganti dengan email tujuan kamu
